...
# OBS : A pasta de imagens do pato não foi usada, mas ela está aí pois dei um clone no seu repositorio e atualizei o trab1,2 e 3 em meu próprio repositório, com um fork para o seu
